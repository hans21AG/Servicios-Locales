...
export const metadata = {
  ...
  description: 'Encuentra manitas profesionales en Ciudad Real. Reparaciones del hogar, montaje de muebles y pequeñas obras. Presupuestos gratis.',
  keywords: 'manitas ciudad real, manitas hogar, reparaciones hogar ciudad real, handyman ciudad real',
};
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-xl text-[#4B5563] leading-relaxed">
            ...
            para reparaciones del hogar, montaje de muebles y pequeñas obras.
